...
class TerminalViewController: UIViewController {
	...
	override var keyCommands: [UIKeyCommand]? {
		return [
			...
			UIKeyCommand(input: UIKeyCommand.inputUpArrow, modifierFlags: [], action: #selector(selectPreviousCommand), discoverabilityTitle: "Previous command"),
			UIKeyCommand(input: UIKeyCommand.inputDownArrow, modifierFlags: [], action: #selector(selectNextCommand), discoverabilityTitle: "Next command")
		]
	}
